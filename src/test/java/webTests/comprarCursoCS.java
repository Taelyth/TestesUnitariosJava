...
public class comprarCursoCS {
    ...
    public void clicoNaImagemDeUmCurso() {
        ...
        // Ir com o mouse até o elemento (mouse over):
        Actions actions = new Actions(driver);
        actions.moveToElement(saibaMais).build().perform();

        // build() é para juntar todas as actions em uma só, no caso se tiver que colocar o mouse em cima de dois botões
        // perform() é para realizar a action

        wait.until(ExpectedConditions.textToBePresentInElement(saibaMais, "+ SAIBA MAIS"));
    ...
    public void vejoAPaginaComDetalhesDoCurso() {
        wait.until(ExpectedConditions.titleIs("Formação em Teste de Software (On Demand) - Iterasys"));
